    ...
    <main className={`${styles.page} envista-auth-page`}>
      <div className={`${styles.shell} ${wide ? styles.wide : ""}`}>
        <aside className={`${styles.brandPanel} envista-auth-brand`}>
          <Link className={styles.brand} href="/" aria-label="Ir para a página inicial do Envista"><Image src="/envista-logo.png" alt="" width={42} height={42} priority /><span>Envista</span></Link>
        ...
        <section className={styles.formPanel}>
          <Link className={`${styles.mobileBrand} envista-auth-mobile-brand`} href="/" aria-label="Ir para a página inicial do Envista"><Image src="/envista-logo.png" alt="" width={34} height={34} /><span>Envista</span></Link>
