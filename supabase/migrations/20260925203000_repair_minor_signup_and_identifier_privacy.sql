...
-- repairs every affected guardian/signup function, protects all users under 18,
-- and removes the anonymous CPF/CNPJ availability oracle.
--
-- Apply only after the application stops calling signup_identifier_available().
